...
class TestModelsForCheckoutApp(TestCase):
    def test_buy_product(self):
        """To test the Order model works by collecting
        the correct information from the user
        """
        date_now = timezone.now()
        order = Order(full_name="John Doe", phone_number="0192837465",
                      country="Nigeria", postcode="987654",
                      town_or_city="Calabar", street_address1="Raeburn",
                      street_address2="Road", county="Nigeriashire",
                      date=date_now)
